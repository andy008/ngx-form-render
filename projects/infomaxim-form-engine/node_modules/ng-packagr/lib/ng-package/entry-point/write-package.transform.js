...
exports.writePackageTransform = transform_1.transformFromPromise(async (graph) => {
    const spinner = ora({
        hideCursor: false,
        discardStdin: false,
    });
 ...
 */
async function writePackageJson(entryPoint, pkg, additionalProperties, isIvy, spinner) {
    var _a, _b, _c;
    ...
    try {
        ...
        await fs_1.rimraf(entryPoint.destinationPath);
        throw e;
    }
